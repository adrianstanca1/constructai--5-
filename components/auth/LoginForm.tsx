...
const LoginForm: React.FC<LoginFormProps> = ({ onLoginSuccess }) => {
    const [email, setEmail] = useState('casey@constructco.com');
             ...
             <div className="bg-blue-50 border-l-4 border-blue-400 p-4">
                <div className="flex">
                    ...
                    <div className="ml-3">
                        ...
                        Demo: Use <code className="font-bold">casey@constructco.com</code> or <code className="font-bold">susan@constructco.com</code>. Password is <code className="font-bold">password123</code>.
                        </p>
                    </div>
                </div>
            </div>
